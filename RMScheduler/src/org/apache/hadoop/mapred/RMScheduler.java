...
import org.apache.hadoop.mapred.RMJobInProgressListener.JobSchedulingInfo;
...
public class RMScheduler extends TaskScheduler {
	  ...
	  public RMScheduler() {
	    this.jobListener = new RMJobInProgressListener();
	  }
	  ...
	  public synchronized void start() throws IOException {
		...
		//启动后，统计不同工作流的资源占用情况		
		new ResourceOccupyRM(jobListener).start();
	  }
