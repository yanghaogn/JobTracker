...
public class RMJobInProgressListener extends JobInProgressListener {
	  ...
	  public RMJobInProgressListener() {
	   ...
	   */
	  protected RMJobInProgressListener(Map<JobSchedulingInfo, 
