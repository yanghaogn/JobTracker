...
import org.apache.hadoop.mapred.LLFJobInProgressListener.JobSchedulingInfo;
...
public class LLFScheduler extends TaskScheduler {
	...
	protected LLFJobInProgressListener jobListener;
	protected EagerTaskInitializationListener eagerTaskInitializationListener;
	private float padFraction;

	public LLFScheduler() {
		this.jobListener = new LLFJobInProgressListener();
	...
	public synchronized void start() throws IOException {
		...
		new ResourceOccupyLLF(jobListener).start();
