...
import org.apache.hadoop.mapred.EDFJobInProgressListener.JobSchedulingInfo;
...
public class EDFScheduler extends TaskScheduler {
	  ...
	  public EDFScheduler() {
	    this.jobListener = new EDFJobInProgressListener();
	  }
	  ...
	  public synchronized void start() throws IOException {
		...
		//启动后，统计不同工作流的资源占用情况		
		new ResourceOccupyEDF(jobListener).start();
	  }
